-- 033: Exclude group chats from merge suggestions entirely.
-- Groups matching individuals by name was creating duplicate/broken clusters.
...
BEGIN
  ...
  -- Pre-filter: identify persons that are groups (have any group-type message)
  ...
  FROM (
    ...
    -- Name similarity (cross-channel only)

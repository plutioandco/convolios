-- 016: Restore real unread count in get_conversations RPC.
-- Migration 010 stubbed unread_count to 0 for performance during development.
-- Now wiring it back to the actual read_at-based count.
-- avatar_url is excluded to avoid serializing ~25MB of base64 data URIs;
-- the frontend loads avatars separately from the persons table.
